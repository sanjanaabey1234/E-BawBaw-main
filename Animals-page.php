              ...
              <p>
                ...
                <span class="right badge badge-danger">New</span>
                        ...
                        <li class="nav-item menu-open">
                            <a href="Animals-page.php" class="nav-link active">
                                <i class="nav-icon fas fa-th"></i>
                                <p>
                                    Animals
                                </p>
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">All Fellow at Baw Baw</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <button class="btn btn-primary" style="margin-right: 30px;"
                                    onclick="window.location.href='http://localhost/E-BawBaw-main/pages/examples/add_animal.html'">Add
                                    New Animals</button>
...
$sql = "SELECT * FROM Animals";
        ...
        <td>{$row['age']}</td>
         <td>
                                  <form action='http://localhost/E-BawBaw-main/pages/examples/profile.php' method='POST' class='inline-form'>
                                        <input type='hidden' name='id' value='{$row['id']}'>
                                        <button type='submit' class='link-button'>View</button>
                                  </form>
                                </td>
                                <td><a href='{$row['link']}'>View</a></td>
                                <td><a href='http://localhost/E-BawBaw-main/pages/examples/edit_animal.php?id={$row['id']}' class='edit-btn'>Edit</a></td>
                                 <td>
                                    <a href='http://localhost/E-BawBaw-main/pages/examples/delete_animal.php?id={$row['id']}' class='delete-btn' onclick='return confirm(\"Are you sure you want to delete this record?\")'>Delete</a>
                                </td>
                              </tr>";
    }
} else {
