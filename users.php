        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <div class="sidebar">
               ...
               with font-awesome or any other icon font library -->
                        <li class="nav-item">
                            <a href="main-page.php" class="nav-link">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <button class="btn btn-primary" style="margin-right: 30px;"
                                    onclick="window.location.href='add_new_user.php'">Add New User</button>
                ...
                if ($result->num_rows > 0) {
                    while($row = $result->fetch_assoc()) {
                        echo "<tr>
                                ...
                                <td>Online</td>
                                <td><button class='edit-btn'><a href='edit_user.php?id={$row['id']}' class='edit-btn'>Edit</a></button></td>
                                <td><button class='delete-btn'><a href='delete_user.php?id={$row['id']}' class='delete-btn'>Delete</a></button></td>
                              </tr>";
                    }
                } else {
