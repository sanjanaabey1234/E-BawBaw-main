...
if (isset($_GET['id'])) {
    ...
    $sql = "SELECT * FROM Sterilization WHERE id = ?";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Update data in the Sterilization table
    $sql = "UPDATE Sterilization SET name=?, client_name=?, animal_type=?, location=?, sex=?, age=?, nic=?, kids=?, count=?, contact=?, form=? WHERE id=?";
    $stmt = $conn->prepare($sql);
    if (!$stmt) {
        die("Prepare failed: (" . $conn->errno . ") " . $conn->error);
    }
    $stmt->bind_param("sssssiissssi", $name, $client_name, $animal_type, $location, $sex, $age, $nic, $kids, $count, $contact, $form, $id);
    if (!$stmt->execute()) {
        die("Execute failed: (" . $stmt->errno . ") " . $stmt->error);
    }

    // Success
    echo "<script>alert('Record updated successfully.'); window.location.href = 'Edit_Sterilization.php?id=$id';</script>";
...
<head>
    ...
    <title>E - BawBaw | Edit Sterilization</title>
    <!-- Custom Styling -->
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Edit Sterilization Record</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="main-page.html">Home</a></li>
                                <li class="breadcrumb-item active">Edit Sterilization</li>
                            </ol>
                        </div><!-- /.col -->
                    </div><!-- /.row -->
                </div><!-- /.container-fluid -->
            ...
            <section class="content">
                <div class="container-fluid">
                    ...
                    <form action="Edit_Sterilization.php?id=<?php echo $id; ?>" method="POST">
                        <div class="card card-default">
                            <div class="card-header">
                                <h3 class="card-title">Sterilization Form</h3>
                            </div>
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="animal_type" name="animal_type"
                                                value="<?php echo htmlspecialchars($row['animal_type']); ?>"
                                                placeholder="Enter Animal Type" required>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="location" name="location"
                                                ...
                                                placeholder="Enter Location of the Client" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control select2" id="sex" name="sex" style="width: 100%"
                                                required>
                                                <option value="Male"
                                                    <?php if ($row['sex'] == 'Male') echo 'selected'; ?>>Male</option>
                                                <option value="Female"
                                                    <?php if ($row['sex'] == 'Female') echo 'selected'; ?>>Female
                                                </option>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" id="kids" name="kids"
                                                value="<?php echo htmlspecialchars($row['kids']); ?>"
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" id="count" name="count"
                                                value="<?php echo htmlspecialchars($row['count']); ?>"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="form" name="form"
                                                value="<?php echo htmlspecialchars($row['form']); ?>"
                                                placeholder="Enter Form Number" required>
                                        </div>
                                    </div>
                                </div>
